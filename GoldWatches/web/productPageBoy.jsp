			...
			<div class="container">	
				<div class="col-md-12">
					<div class="product col-md-3 service-image-left">
						...
						<center>
							<img id="item-display" src="boy.jpg" alt=""></img>
						</center>
					</div>
				...
				<div class="col-md-7">
					<div class="product-title">CEAS HEAD</div>
					<div class="product-desc">Model HE-105-01 Mecanism Quartz Indica: Ora, minut,secunda, data, zi Functii: Alarma, timer, cronometru, lumina</div>
				...
				<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade in active" id="service-one">
							...
							<section class="container product-info">
								Model HE-105-01
                                Tip: Barbatesc
                                Rezistenta la apa: 3 atm
                                Mecanism Quartz
                                Indica: Ora, minut,secunda, data, zi
                                Material Geam: Acrilat
                                Carcasa: Rasina
                                Dimensiune carcasa: 57 mm x 13 mm
                                Forma: Rotunda
                                Material curea: Cauciuc
                                Lungime curea: 22.5 cm
                                Latime curea: 22-30 mm
                                Sistem inchidere: Catarama standard
                                Functii: Alarma, timer, cronometru, lumina
                                Greutate: 65 grame
