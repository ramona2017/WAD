			...
			<div class="container">	
				<div class="col-md-12">
					<div class="product col-md-3 service-image-left">
						...
						<center>
							<img id="item-display" src="smartwatch.jpg" alt=""></img>
						</center>
					</div>
					...
					<div class="container service1-items col-sm-2 col-md-2 pull-left">
						<center>
							<a id="item-1" class="service1-item">
								<img src="smartwatch.jpg" alt=""></img>
							</a>
				...
				<div class="col-md-7">
					<div class="product-title">SMARTWATCH VOGUE</div>
					<div class="product-desc">SMARTWATCH VOGUE Q18 CURVED CU CAMERA SI TELEFON 3G DISPLAY 1.54" BLUETOOTH</div>
				...
				<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade in active" id="service-one">
							...
							<section class="container product-info">
								Functionalitati Rich:
                                Self Shooting cu ajutorul telecomenzii ;
                                Sistem Anti Pierdere Bidirectional. Cautare Bidirectionala；
                                 varietate de sincronizare a Aplicatiilor: SMS, QQ, WEChat, Twitter, Facebook, Watsup, etc.
                                Sport si Sanatate:Pedometru、Detectarea Somnului、Sedentary remind；
